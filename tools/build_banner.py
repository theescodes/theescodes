...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="320" viewBox="0 0 1200 320" role="img" aria-labelledby="t">
  ...
  <defs>
    ...
    <!-- Anchored in user space at the lamp, so it stays correctly oriented
         however the beam group is rotated. An objectBoundingBox gradient
         runs left-to-right across the box and inverts on the left-hand beam. -->
    <linearGradient id="beam" gradientUnits="userSpaceOnUse" x1="1047" y1="86" x2="1470" y2="86">
      <stop offset="0" stop-color="#ffe6d2" stop-opacity=".5"/>
      <stop offset=".28" stop-color="#ff8a4d" stop-opacity=".17"/>
      <stop offset=".7" stop-color="#f54900" stop-opacity=".05"/>
      <stop offset="1" stop-color="#f54900" stop-opacity="0"/>
    </linearGradient>
    <linearGradient id="feather" gradientUnits="userSpaceOnUse" x1="1047" y1="18" x2="1047" y2="154">
      <stop offset="0" stop-color="#000"/><stop offset=".38" stop-color="#fff"/>
      <stop offset=".62" stop-color="#fff"/><stop offset="1" stop-color="#000"/>
    </linearGradient>
    <mask id="beammask"><rect x="1000" y="10" width="520" height="152" fill="url(#feather)"/></mask>
  ...
  <g clip-path="url(#frame)">
    ...
    <g class="sweep"><polygon points="1047,86 1470,26 1470,146" fill="url(#beam)" mask="url(#beammask)"/></g>
    <g class="sweep" style="animation-delay:-3.5s"><polygon points="1047,86 1470,26 1470,146" fill="url(#beam)" mask="url(#beammask)" opacity=".5"/></g>
